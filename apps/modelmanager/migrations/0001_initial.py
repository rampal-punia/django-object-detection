    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('class_file', models.FileField(help_text='Ml Model classes file. Allowed extensions are: .txt, .names', upload_to=modelmanager.models.model_classfile_upload_path, validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['txt', 'TXT', 'names', 'names'])], verbose_name='Ml Model Classes file')),
                ('description', models.TextField(verbose_name="Model's description")),
                ('model_version', models.CharField(blank=True, max_length=51, null=True, verbose_name='Ml Model Version')),
            ],
            options={
                'abstract': False,
            },
